...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_path', type=str, default='samples/rabbit.jpg')
    parser.add_argument('--src_prompt', type=str, default="a watercolor painting of a white rabbit")
    parser.add_argument('--tgt_prompt', type=str, default="a watercolor painting of a pink rabbit")
    parser.add_argument('--img_shape', type=int, default=768, help='Image shape for editing')
    parser.add_argument('--cfg_scale', type=float, default=7.5, help='CFG scale for editing')
